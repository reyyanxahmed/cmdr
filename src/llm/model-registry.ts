...
const SEED_MODELS: ModelInfo[] = [
  ...
  { name: 'qwen3-max', contextLength: 262144, supportsTools: true, parameterSize: 'cloud', recommended: 'heavy' },
  { name: 'qwen3-max-preview', contextLength: 262144, supportsTools: true, parameterSize: 'cloud', recommended: 'heavy' },
  { name: 'qwen3.6-plus', contextLength: 1000000, supportsTools: true, parameterSize: 'cloud', recommended: 'heavy' },
  { name: 'qwen3.6-plus-2026-04-02', contextLength: 1000000, supportsTools: true, parameterSize: 'cloud', recommended: 'heavy' },
  // Llama family
